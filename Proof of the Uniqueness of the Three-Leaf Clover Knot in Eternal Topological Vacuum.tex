...
- Chern-Simons energy minimization.
- Target linking/winding for stability (L_k = 6 for Ising, high w for Fibonacci).
- Bonus for fusion rules non-trivial (Ising trefoil or Fibonacci high-winding).
